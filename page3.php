...
<html>
    ...
    <body id ="froom" >
        <?php 
          ...
          $a = "'".$_SESSION['email']."'" ;
          //echo $a ;
          $stm = $bdd->prepare("SELECT `QRCODE3` FROM `users` WHERE `Email`= $a");
                 $stm->execute();              
          ...
          $st = $bdd->prepare("SELECT `HEURE3` FROM `users` WHERE `Email`= $a");
                 $st->execute();              
        ...
        <h1 style="text-align:center" id ="email" title="<?php echo($_SESSION['email'])?>">Vous avez choisi l'appareil à raclette !</h1>
    ...
    <script src="./funct3.js" type="text/javascript"></script>
