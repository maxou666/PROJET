...
<body id="froom" class="text-center">
    <?php 
          ...
          $a = "'".$_SESSION['email']."'" ;
          //echo $a ;
          $stm = $bdd->prepare("SELECT `QRCODE4` FROM `users` WHERE `Email`= $a");
                 $stm->execute();              
          ...
          $st = $bdd->prepare("SELECT `HEURE4` FROM `users` WHERE `Email`= $a");
                 $st->execute();              
...
<div class="container">
        <h1 id="email" title="<?php echo($_SESSION['email'])?>"> Vous avez choisi les pinces !</h1>
...
<script src="./funct4.js" type="text/javascript"></script>
